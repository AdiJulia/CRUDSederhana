/*
 ...
 Source Schema         : jayamakmur

 Target Server Type    : MySQL
 Target Server Version : 90001 (9.0.1)
 File Encoding         : 65001

 Date: 02/03/2025 12:59:30
*/
...
CREATE TABLE `produk`  (
  ...
  `jumlah_produk` bigint NOT NULL,
  `harga_produk` bigint NOT NULL,
  `id_bahan` bigint UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `produk_id_bahan_foreign`(`id_bahan` ASC) USING BTREE,
  CONSTRAINT `produk_id_bahan_foreign` FOREIGN KEY (`id_bahan`) REFERENCES `bahan` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
